...
const getSelectAllProfessionals = async() =>{
    ...
    try{
    //Sricpt SQL
    let sql =  'select * from tbl_profissional order by profissional_id desc'
...
const getSelectByIdProfessional = async function(id){
    try{
        //Sricpt SQL
        let sql =  `select * from tbl_profissional where profissional_id= ${id}`
...
const getSelectLastID = async function(){
    try {
        ...
        let sql = `select id from tbl_profissional order by profissional_id desc limit 1`
        let result = await prisma.$queryRawUnsafe(sql)
...
const setUpdateProfessionals = async function(profissional){
    try {
        let sql = `UPDATE tbl_profissional SET
            ...
            biografia='${filme.biografia}'
            WHERE profissional_id=${filme.id};
            `
...
const setDeleteProfessionals = async function(id){
    try {
        //Script SQL
        let sql = `delete from tbl_profissional where profissional_id=${id}`
